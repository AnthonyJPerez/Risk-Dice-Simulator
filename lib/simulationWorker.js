...
function runSimulations(parameters) {
	...
	var avgAttackerArmiesRemaining = simulationOutcomes.filter(function (stat) {
		...
		return _Log("Avg attacker armies remaining on wins: %d (%d armies)", 100 * armiesRemaining, armiesRemaining * initialAttackerArmies);
	}, function () {}, // onError, do nothing.
	function () {}); // onComplete, do nothing.
	...
	var averageDefenderArmyLoss = simulationOutcomes.filter(function (stat) {
		...
		return _Log("Avg attacker armies remaining on losses: %d (%d armies)", 100 * armiesRemaining, armiesRemaining * initialDefenderArmies);
	}, function () {}, // onError, do nothing.
	function () {}); // onComplete, do nothing.
